...
var messagesSent = 0;
var announcements = 0;
var recovDataMessages = 0;
var recovCtrlMessages = 0;
var beaconMessages = 0;
var totalCrashes = 0;
...
function endSimulation() {
    ...
    log.log("Beacons sent: " + beaconMessages + "\n");
    log.log("Recovery messages sent: " + announcements + "\n");
...
while (true) {
    ...
    if (msg.indexOf('sending recovery ctrl msg') > -1) {
        recovCtrlMessages++;
    }
    if (msg.indexOf('sending recovery data msg') > -1) {
        recovDataMessages++;
    }
    if (msg.indexOf('Sending beacon message') > -1) {
        beaconMessages++;
    }
